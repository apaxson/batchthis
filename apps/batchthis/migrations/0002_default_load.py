...
def loadDefaults(apps, schema_editor):
    ...
    FermentableType = apps.get_model('batchthis', 'FermentableType')
    FermentableType.objects.using(db).create(name="Juice")
    FermentableType.objects.using(db).create(name="Honey")
    FermentableType.objects.using(db).create(name="Extract")
    FermentableType.objects.using(db).create(name="Fruit")
    FermentableType.objects.using(db).create(name="Grain")
    FermentableType.objects.using(db).create(name="Sugar")

    AdjunctType = apps.get_model('batchthis','AdjunctType')
    AdjunctType.objects.using(db).create(name='Nutrient')
    AdjunctType.objects.using(db).create(name='Flavoring')
    AdjunctType.objects.using(db).create(name='Stablizer')
    AdjunctType.objects.using(db).create(name='Fining')
    AdjunctType.objects.using(db).create(name='Water Agent')
    AdjunctType.objects.using(db).create(name='Tannin')
    AdjunctType.objects.using(db).create(name='Enzyme')
